...
import './ForgotPasswordInstructor.css';
...
const ForgotPasswordPageInstructor = () => {
        ...
        <div className="forgot-password-page">
            ...
            <main className="forgot-password-main">
                <div className="forgot-password-container">
                    ...
                    <a href="/login-instructor" className="back-link-forgot">
...
export default ForgotPasswordPageInstructor;