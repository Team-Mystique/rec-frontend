...
import './SignUpPageStudent2.css';

const logoUrl = '/logo.png';

const SignUpPageStudent2 = () => {
  ...
  useEffect(() => {
    if (location.state && location.state.user_data) {
      ...
      navigate('/signup-student-1'); // Assuming '/signup' is the route for the first step.
    }
  ...
  const handleContinue = (e) => {
    ...
    if (Object.keys(formErrors).length > 0) {
      ...
      navigate('/signup-student-3', { state: { user_data: combinedData } });
    }
  };
...
export default SignUpPageStudent2;